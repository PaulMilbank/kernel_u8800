...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	{ 0, 245760, PLL_3,    5, 2,  61440000,  875, VDD_RAW(875), LOW },
	{ 1, 368640, PLL_3,    5, 1,  122800000, 900, VDD_RAW(900), LOW },
	{ 1, 480000,  PLL_2,    3, 0,    122800000, 925,  VDD_RAW(925),  NOMINAL, &pll2_tbl[0]},
	{ 1, 600000,  PLL_2,    3, 0,    122800000, 950,  VDD_RAW(950),  NOMINAL, &pll2_tbl[1]},
	/* AXI has MSMC1 implications. See above. */
	{ 1, 768000, PLL_1,    2, 0,  153600000, 975, VDD_RAW(975), NOMINAL },
	/*
	 * AXI has MSMC1 implications. See above.
	 */
	{ 1, 806400,  PLL_2, 3, 0, UINT_MAX, 1000, VDD_RAW(1000), NOMINAL, &pll2_tbl[2]},
	{ 1, 1024000, PLL_2, 3, 0, UINT_MAX, 1100, VDD_RAW(1100), NOMINAL, &pll2_tbl[3]},
